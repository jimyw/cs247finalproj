...
(function() {
  ...
  fb_instance = new Firebase("https://jjdcs247p4.firebaseio.com");

  $(document).ready(function(){
    connect_to_collage_firebase();
    connect_webcam();
  });
  ...
  function initialize_collage() {
    ...
    display_msg({m:"Share this url with your friend to collaborate: "+ document.location.origin+"/#"+fb_collage_id,c:"red"})

    var fb_new_collage = fb_instance.child('Collage').child(fb_collage_id);
    for (int i=0; i<numTiles; i++) {
      ...
      var fb_instance_users = fb_new_tile.child('users'); 
      var fb_instance_stream = fb_new_tile.child('stream');
    }
  }

  function connect_to_collage_firebase(){
    ...
    var fb_instance_users = fb_new_tile_id.child('users');
    var fb_instance_stream = fb_new_tile_id.child('stream');
